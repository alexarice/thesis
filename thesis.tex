...
Using only this proposition we can immediately prove typing properties for several constructions using discs.
...
\todo[inline]{Could have instead closed rules under substitution}
\todo[inline]{Possibly not worth considering anything non-tame}
