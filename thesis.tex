...
\todo[inline]{Cattsua more complicated}
\todo[inline]{At a first glance is not much more powerful}
\todo[inline]{Look at analogue for disc removal}
\todo[inline]{Cylinders are possible motivation here}
\todo[inline]{Look at link to graphical methods}
...
\[
  \begin{tikzcd}
    ...
    \arrow[shorten <=4pt, shorten >=4pt, Rightarrow, from=4, to=2]
  \end{tikzcd}
\]
...
\todo[inline]{Forest counterexample to merging}
% \paragraph{Alternatives to endo-coherence removal}
% \todo[inline]{Endo-coherence removal variation?}

% \paragraph{A comparison with \textsc{homotopy.io}}
