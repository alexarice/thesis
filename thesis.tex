  ...
  \begin{align*}
    \Gamma \vdash_{\sua'} t &= \id(b \sub {\kappa_{S,P,T}}) \sub {\insertion L P M}\\
                            ...
                            &= \id(b) \sub L\\
                              &\equiv s
  \end{align*}
  where the first equality is by endo-coherence removal, and the second equality is by \cref{lem:kappa-iota-insert}, appealing to the induction on dimension.
...
\todo[inline]{Termination}
\todo[inline]{Confluence, introducing lemmas as needed}
