...
\begin{definition}
  ...
  \begin{alignat*}{2}
    ...
    &\mathcal{U}_\Delta^{n+1} &&= \arr {\mathcal{T}_{\bound n \Delta}^n \sub {\incbd n - \Delta}} {\mathcal{U}_\Delta^n} {\mathcal{T}_{\bound n \Delta}^n \sub {\incbd n + \Delta}}
  \end{alignat*}
