...
\begin{proposition}
  Let \(\mathcal{R}\) satisify the weakening condition. Then the following inference rules are derivable in \Cattr.
  \begin{mathpar}
...
\begin{lemma}
  ...
  For all \(n \in \mathbb{N}\). Further, the following inference rules are derivable:
  \begin{mathpar}
