...
\begin{proposition}
  Let \(m \leq n\) and let \(T\) be a tree. Then:
  \[ \bound m {\bound n T} \equiv \bound m T\]
  Further, for \(\epsilon, \omega \in \{-,+\}\) we have:
  \[ \incbd m \epsilon {\bound n T} \bullet \incbd n \omega T \equiv \incbd m \epsilon T \]
...
\begin{proof}
  ...
  \begin{align*}
    \Sigma(\stdtm {\bound {n-1} T} {n-1} \sub {\incbd {n-1} \epsilon T}) &\equiv \Sigma(\stdtm {\bound {n-1} T} {n-1}) \sub {\Sigma(\incbd{n-1} \epsilon T)}&\text{by functoriality of suspension}\\
  ...
  \begin{align*}
    \Sigma(\stdty T n) &\equiv \arr {\Sigma(\stdtm {\bound {n-1} T} {n-1} \sub {\incbd {n-1} - T})} {\Sigma(\stdty T {n-1})} {\Sigma(\stdtm {\bound {n-1} T} {n-1} \sub {\incbd {n-1} + T})}\\
...
\todo[inline]{Standard type globularity lem}

\todo[inline]{Support for standard}

\todo[inline]{Typing for standard}
...
\todo[inline]{Term is coherence under disc removal}
