...
\subsection{Syntax}\todo{Work out how to do links}
\label{sec:syntax}
...
\begin{itemize}
\item The core syntax is defined in \texttt{Catt.Syntax.Base}.
\item Suspension is defined in \texttt{Catt.Suspension}.
\item Other syntactic operations are defined in \texttt{Catt.Syntax}, which re-exports the core syntax.
\end{itemize}
