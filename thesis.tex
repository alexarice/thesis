...
\[ \mathsf{def} v = s \mid \mathsf{def} v \Gamma = s \mid \mathsf{def} v \Gamma : A = s \]
...
The span information allows more informative error messages to be given. These error messages are formatted using the \href{https://docs.rs/ariadne/latest/ariadne/}{ariadne} crate. An example error message is given below:
